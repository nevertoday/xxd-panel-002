...
That frustration is why I made **Panel 002**. It does not press a template onto your image. It first works out what must not be lost, then translates it into **Translate a photograph into narrative contour, hesitant hand line, and misregistered vintage editorial print**.
...
<table>
  ...
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 002 Sample 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 002 Sample 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 002 Sample 8"></td>
  </tr>
</table>
